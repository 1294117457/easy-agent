...
import type { McpConfig, McpConfigInput } from '@/stores/workflow';
...
async function parseConfig() {
  ...
  try {
    ...
    if (result.success) {
      parsedConfig.value = result.servers as unknown as McpConfig;
      requiredInputs.value = (result.inputs || []) as McpConfigInput[];
